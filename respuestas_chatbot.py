    ...
    for Intento in JsonIntentos['intents']:
        if Intento['tag'] == Etiqueta:
            ...
            if Intento['tag'] == "fecha":
                ...
                return generar_respuesta_area(nombre_area="Apoyo Nutricional ", emoji="🍎", piso="2", encargado="",
                ...
                return generar_respuesta_area(nombre_area="Central de Cuentas ", emoji="📋", piso="#", encargado="",
                    extensiones=[("Central de Cuentas", "7014")]
                )
            elif Intento['tag'] == "centro_mezclas":
                return generar_respuesta_area(nombre_area="Centro de Mezclas ", emoji="💉", piso="#", encargado="",
                ...
                return generar_respuesta_area(nombre_area="Cobranza ", emoji="💸", piso="#", encargado="",
                    extensiones=[("Cobranza", "7020")]
                )
            elif Intento['tag'] == "cocina":
                return generar_respuesta_area(nombre_area="Cocina ", emoji="🍽️", piso="2", encargado="",
                ...
                return generar_respuesta_area(nombre_area="Enseñanza Dos ", emoji="📚", piso="6", encargado="",
                ...
                return generar_respuesta_area(nombre_area="Especialidades ", emoji="🔍", piso="#", encargado="",
                    extensiones=[("Especialidades", "7038")]
                )
            elif Intento['tag'] == "espesialidades_enfermeria":
                return generar_respuesta_area(nombre_area="Especialidades Enfermeria ", emoji="👩‍⚕️", piso="#", encargado="",
                ...
                return [
                    ...
                    '<button class="info" onclick="Mostrar(\'Oncología Banco de Sangre\')">Banco de Sangre</button><b> </b>'
                    '<button class="infoArea" onclick="Mostrar(\'Oncología Catéteres\')">Catéteres</button><b> </b>'
                    '<button class="infoArea" onclick="Mostrar(\'Oncología Jefatura\')">Jefatura</button><b> </b>'
                    '<button class="infoArea" onclick="Mostrar(\'Oncología Jefe\')">Jefe</button><b> </b>'
                    '<button class="infoArea" onclick="Mostrar(\'Oncología Oficina Hematología\')">Oficina Hematología</button><b> </b>'
                    '<button class="infoArea" onclick="Mostrar(\'Oncología Oficina Secretaría\')">Oficina Secretaría</button><b> </b>'
                    '<button class="infoArea" onclick="Mostrar(\'Oncología Quimioterapia Ambulatoria\')">Quimioterapia Ambulatoria</button><b> </b>'
                    '<button class="infoArea" onclick="Mostrar(\'Oncología Recepción Consulta\')">Recepción Consulta</button><b> </b>'
                    '<button class="infoArea" onclick="Mostrar(\'Oncología Residentes\')">Residentes</button><b> </b>'
                    '<button class="infoArea" onclick="Mostrar(\'Oncología TS Hospitalización\')">TS Hospitalización</button><b> </b>'
                    '<button class="infoArea" onclick="Mostrar(\'Oncología Somatometría\')">Somatometría</button><b> </b>'
                    '<button class="infoArea" onclick="Mostrar(\'Oncología Tumores\')">Tumores</button><b> </b>'
                    '<button class="info" onclick="Mostrar(\'Oncología Sala\')">Sala</button><b> </b>'
                ...
                return [
                    ...
                    '<button class="info" onclick="Mostrar(\'Subdirección Médica\')">Sub. Médica</button><b> </b>'
            ...
            elif Intento['tag'] == "jefatura_especialidades":
                return generar_respuesta_area(nombre_area="Jefatura Especialidades ", emoji="🩺", piso="#", encargado="Dr. Jorge Rolando Romero Bazua ",
                    extensiones=[("Jefatura Especialidades", "7107")]
                )
                ...
                return generar_respuesta_area(nombre_area="Surtimiento de Recetas ", emoji="💊", piso="#", encargado="Enf. María del Rosario Chamorro Chairez ",
                ...
                return generar_respuesta_area(nombre_area="Hemodiálisis ", emoji="❤️‍🩹", piso="3", encargado="",
                ...
                return [
                    f'<section class="card">'
                        f'<header>'
                            f'<p> <b><button class="info pisos" style="font-size: 20px; padding-bottom: 0px;" onclick="Mostrar(\'Piso 1\')">Piso 1</button></b> <span class="info emoji">🏢</span></p>'
                        f'</header>'
                    f'</section>',
                    Respuesta,
                ...
                return [
                    f'<section class="card">'
                        f'<header>'
                            f'<p> <b><button class="info pisos" onclick="Mostrar(\'Piso 2\')">Piso 2</button></b> <span class="info emoji">🏢</span></p>'
                        f'</header>'
                    f'</section>',
                    Respuesta,
                ...
                return [
                    f'<section class="card">'
                        f'<header>'
                            f'<p> <b><button class="info pisos" onclick="Mostrar(\'Piso 3\')">Piso 3</button></b> <span class="info emoji">🏢</span></p>'
                        f'</header>'
                    f'</section>',
                    Respuesta,
                ...
                return [
                    f'<section class="card">'
                        f'<header>'
                            f'<p> <b><button class="info pisos" onclick="Mostrar(\'Piso 4\')">Piso 4</button></b> <span class="info emoji">🏢</span></p>'
                        f'</header>'
                    f'</section>',
                    Respuesta,
                ...
                return [
                    f'<section class="card">'
                        f'<header>'
                            f'<p> <b><button class="info pisos" onclick="Mostrar(\'Piso 5\')">Piso 5</button></b> <span class="info emoji">🏢</span></p>'
                        f'</header>'
                    f'</section>',
                    Respuesta,
                ...
                return [
                    f'<section class="card">'
                        f'<header>'
                            f'<p> <b><button class="info pisos" onclick="Mostrar(\'Piso 6\')">Piso 6</button></b> <span class="info emoji">🏢</span></p>'
                        f'</header>'
                    f'</section>',
                    Respuesta,
                ...
                return [
                    f'<section class="card">'
                        f'<header>'
                            f'<p> <b><button class="info pisos" onclick="Mostrar(\'Planta Baja\')">Planta Baja</button></b> <span class="info emoji">🏢</span></p>'
                        f'</header>'
                    f'</section>',
                    Respuesta,
                    '<b>Diferentes áreas de la Planta Baja</b>'
                    '\n<button class="info" onclick="Mostrar(\'Farmacia\')">Farmacia</button><b> </b>'
                    '<button class="info" onclick="Mostrar(\'Almacen General y Activos Fijos\')">Almacén General y Activos Fijos</button><b> </b>'
                ...
                return [
                    f'<section class="card">'
                        f'<header>'
                            f'<p> <b><button class="info pisos" onclick="Mostrar(\'Edificio Viejo\')">Edificio Viejo</button></b> <span class="info emoji">🏢</span></p>'
                        f'</header>'
                    f'</section>',
                    Respuesta,
